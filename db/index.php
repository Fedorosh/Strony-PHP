...
<body>
 ...
 // }
	...
	$rezultat1 = mysqli_query($polaczenie, "SELECT * FROM klienci");
            $rezultat2 = mysqli_query($polaczenie, "SELECT * FROM ksiazki");
...
<input type = "text" name = "imieautora"/>
<input type = "text" name = "nazwiskoautora"/>
